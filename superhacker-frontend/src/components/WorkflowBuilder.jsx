...
export function WorkflowBuilder() {
  ...
  const nodeCategories = {
    ...
    ml_supervised: Object.values(NODE_TYPES).filter(type => type.category === 'ml_supervised'),
    ml_unsupervised: Object.values(NODE_TYPES).filter(type => type.category === 'ml_unsupervised'),
    deep_learning: Object.values(NODE_TYPES).filter(type => type.category === 'deep_learning'),
    evaluation: Object.values(NODE_TYPES).filter(type => type.category === 'evaluation'),
            ...
            <div>
              ...
              <Tabs defaultValue="input" className="w-full">
                <TabsList className="grid w-full grid-cols-3 mb-2">
                  <TabsTrigger value="input" className="text-xs">Data</TabsTrigger>
                  <TabsTrigger value="preprocessing" className="text-xs">Prep</TabsTrigger>
                  <TabsTrigger value="analysis" className="text-xs">Analysis</TabsTrigger>
                </TabsList>
                <TabsList className="grid w-full grid-cols-3 mb-4">
                  <TabsTrigger value="ml_supervised" className="text-xs">ML-Sup</TabsTrigger>
                  <TabsTrigger value="ml_unsupervised" className="text-xs">ML-Unsup</TabsTrigger>
                  <TabsTrigger value="deep_learning" className="text-xs">Deep</TabsTrigger>
                </TabsList>
                <TabsList className="grid w-full grid-cols-3">
                  <TabsTrigger value="evaluation" className="text-xs">Eval</TabsTrigger>
                  <TabsTrigger value="visualization" className="text-xs">Viz</TabsTrigger>
